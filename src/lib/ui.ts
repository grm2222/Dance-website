...
const mn = {
  ...
  // ── dancers ───────────────────────────────────────────────
  dancersTitle: 'Тамирчид',
  dancersLead: 'Холбооны бүртгэлтэй тамирчид.',
  noDancers: 'Одоогоор бүртгэлтэй тамирчин алга байна.',
  dancerBirthYear: 'Төрсөн он',
  dancerHeight: 'Өндөр',
  dancerCity: 'Хот',
  dancerClub: 'Клуб',
  dancerStandard: 'Стандарт',
  dancerLatin: 'Латин',
  dancerResults: 'Тэмцээний дүн',
  dancerNoResults: 'Одоогоор бүртгэгдсэн дүн алга байна.',
  dancerPartner: 'Хамтрагч',
  dancerPlace: 'байр',
  dancerInactive: 'Идэвхгүй',
  backToDancers: '← Бүх тамирчид',
  dancersCount: 'Нийт',
  pagePrev: 'Өмнөх',
  pageNext: 'Дараах',
...
const en: Strings = {
  ...
  dancersLead: 'Dancers registered with the federation.',
  noDancers: 'No dancers have been registered yet.',
  dancerBirthYear: 'Born',
  dancerHeight: 'Height',
  dancerCity: 'City',
  dancerClub: 'Club',
  dancerStandard: 'Standard',
  dancerLatin: 'Latin',
  dancerResults: 'Competition results',
  dancerNoResults: 'No results have been recorded yet.',
  dancerPartner: 'Partner',
  dancerPlace: 'place',
  dancerInactive: 'Inactive',
  backToDancers: '← All dancers',
  dancersCount: 'Total',
  pagePrev: 'Previous',
  pageNext: 'Next',
